...
<title>User Home Page</title>
	...
	function ValidateDate() 
	{
		...
		document.getElementsByName("journey_dt")[0].setAttribute('min', today);
	}
	function checkroute()
	{
...
<body bgcolor="#EDF">
	...
	<div class="row custom-row">
		<div class="col-md-7"><img src="images/bus1.png" class="img-responsive" /></div>
			<center>
				<div class="typewriter">
  					<span class="blinking">Please Provide Source,Destination & Date To Search Bus !</span>
				</div>
			</center>
			<div class="col-md-5" style="border-width:1px;border-style:solid;border-color:cornflowerblue;height:500px;box-shadow:0px 0px 10px 0px gray;">
				<h3><img src="images/bus-icon.png">&nbsp;Online Bus Ticket Booking</h3><br><br>
				...
				<div class="form-group-lg styled-input">
					...
					<span class="glyphicon glyphicon-map-marker" aria-hidden="true" style="position:relative;top:-30px;margin-left:573px;"></span><br><br>
					<div class="img responsive" style="margin-top:-32px;margin-left:550px;height:45px;"><img src="images/pointingarrow2.gif" style="height:40px;-webkit-transform:rotate(90deg); "></div>
				</div>
				<div class="form-group-lg styled-input">
				...
				<div class="form-group-lg styled-input">
					<input type="date" class="form-control" id="journeydate" class="span2 datepicker" name="journey_dt" placeholder="Enter Journey Date" name="txtDate" onclick="ValidateDate();"><br><br>
					<span class="glyphicon" aria-hidden="true" style="position:relative;top:-68px;margin-left:573px;"></span><br><br>
				</div>
				<input type="submit" value="Search Busses" onclick="checkroute();" class="btn btn-primary" style="width:600px;height:40px;font-weight:bold;">
			</form>
			</div>
	</div>
