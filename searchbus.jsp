...
<%
	...
	try
	{
		...
		PreparedStatement ps=con.prepareStatement("select * from buslist where busname=?");
			...
			<table class="table">
			    ...
			    %>
				 	...
				 	<tr style="color:black;font-size:15px;font-family:sans-serif;font-weight:bold;">
				       ...
				       <%--  <form action="chooseseat.jsp">
				        	<input type="hidden" name="busId" value="<%=rs.getInt("id") %>">
				        	<td><input type="submit" class="btn btn-primary" value="Book Seat"></td>
				        </form> --%>
				     </tr>
